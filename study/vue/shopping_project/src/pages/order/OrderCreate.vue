<template>
  <div class="shopcart-container">
    ...
    <div class="address-container">
      <div class="mui-card" style="background-color: #262627;">
        <router-link :to="{name: 'address_select'}" replace>

            <strong style="color: white;margin-right: 299px">收货地址</strong>

          <h3 style="color: white">{{ address.name }} {{ address.tel }}</h3>
    ...
    <div class="goods-list">
      ...
      <div class="mui-card">
        ...
        <div class="store-info">
          <strong>订单备注</strong>
          <textarea v-model="note" type="text" style="color:black" placeholder="选填，给商家留言"></textarea>
        </div>
      </div>
    </div>
    <!-- 运费信息 -->
    <ul class="fare-info mui-card">
      <li class="fare-price flex">
        <span>商品金额</span>
        <span class="red">¥{{ amount.toFixed(2)/2 }}.00</span>
      </li>
      <li class="fare-price flex">
        <span>运费</span>
